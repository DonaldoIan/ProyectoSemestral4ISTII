...
<section data-bs-version="5.1" class="header6 cid-tF7ER8vk0e mbr-fullscreen mbr-parallax-background" id="header6-30">

    

    
    <div class="mbr-overlay" style="opacity: 0.7; background-color: rgb(213, 228, 255);"></div>

    <div class="align-center container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                <h1 class="mbr-section-title mbr-fonts-style mbr-white mb-3 display-1"><strong>DASHBOARD</strong></h1>
                
                <p class="mbr-text mbr-white mbr-fonts-style display-7">
                    Check your progress in assignments and exams to assess your academic performance. <br>Get detailed information about your performance in different subjects and areas of study. <br>Access updated statistics and results to gain a clear understanding of your strengths and areas for improvement. <br>Use this tool to track your development and make informed decisions about your studies.
                </p>
                <div class="mbr-section-btn mt-3"><a class="btn btn-primary display-4" href="dashboard.php">Track your progress</a></div>
            </div>
        </div>
    </div>
</section>

<section data-bs-version="5.1" class="features3 cid-txoT7iFFOf" id="features3-k">
    
    
    <div class="container">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Practice</strong></h4>
            <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-5">Test your knowledge and skills to climb to a new level!</h5>
        </div>
        <div class="row mt-4">
            <div class="item features-image сol-12 col-md-6 col-lg-6">
                <div class="item-wrapper">
                    ...
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5"><strong>Listening</strong></h5>
                        
                        <p class="mbr-text mbr-fonts-style mt-3 display-7">Practice your listening skills in the English language by doing various exercises that we have prepared for you.</p>
                    </div>
                    <div class="mbr-section-btn item-footer mt-2"><a href="practicelistening.php" class="btn item-btn btn-success display-7">Go for it !</a></div>
                </div>
            </div>
            <div class="item features-image сol-12 col-md-6 col-lg-6">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/mbr-816x629.jpg" alt="">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5"><strong>Reading</strong></h5>
                        
                        <p class="mbr-text mbr-fonts-style mt-3 display-7">Practice your reading and comprehension skills in the English language by doing various exercises that we have prepared for you.</p>
                    </div>
                    <div class="mbr-section-btn item-footer mt-2"><a href="practicereading.php" class="btn item-btn btn-success display-7">Go for it !</a></div>
                </div>
            </div>
